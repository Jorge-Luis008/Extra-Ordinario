...
> ⚠️ **SE REQUIERE CONEXION A INTERNET** La librería SQL.js se carga desde CDN (cdnjs.cloudflare.com). Sin conexión, la aplicación no podrá inicializar la base de datos.

## Cómo ejecutar

1. Clona el repositorio:
   ```bash
   git clone https://github.com/TU_USUARIO/Extra-Ordinario.git
   ```
